...
function setupTest() {
  const noIndentationFields = [defineField({
    type: 'array',
    name: 'array',
  ...
  const onlyIndentationFields = [defineField({
    type: 'string',
    name: 'string',
  ...
  const aliasTypes = [...noIndentationFields, ...onlyIndentationFields].map(field => defineType({ ...field,
