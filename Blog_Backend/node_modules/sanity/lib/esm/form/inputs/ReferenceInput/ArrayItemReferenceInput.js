...
export function ArrayItemReferenceInput(props) {
  ...
  const handleCreateNew = option => {
    const id = uuid();
    const patches = [setIfMissing({}), set(type.name, ['_type']), set(id, ['_ref']), set(true, ['_weak']), set({
      type: option.type,
      weak: type.weak,
  ...
  const handleDuplicate = useCallback(() => {
    if (value !== null && value !== void 0 && value._key) {// todo
      // onInsert?.({
  ...
  }, [onInsert, type.name, value === null || value === void 0 ? void 0 : value._key]);
  const handleChange = useCallback(id => {
    ...
    const patches = [setIfMissing({}), set(type.name, ['_type']), set(getPublishedId(id), ['_ref']), // if there's no published version of this document, set the reference to weak
    hit.published && !type.weak ? unset(['_weak']) : set(true, ['_weak']), hit.published ? unset(['_strengthenOnPublish']) : set({
  ...
  const handleCancelEdit = useCallback(() => {
    ...
    onFocusPath([]);
  }, [onChange, onFocusPath, value === null || value === void 0 ? void 0 : value._ref]);
  ...
  const refType = refTypeName ? type.to.find(toType => toType.name === refTypeName) : undefined; // --- focus handling

  const hasFocusAtRef = focusPath.length === 1 && (focusPath[0] === '_ref' || focusPath[0] === '$'); // const focusElementRef = useForwardedRef(forwardedRef)
  ...
  const hasRef = value && valueHasRef(value); // If the reference value is marked with _strengthenOnPublish,
  ...
  const handleRemoveStrengthenOnPublish = useCallback(() => {
    onChange([type.weak === true ? set(true, ['_weak']) : unset(['_weak']), unset(['_strengthenOnPublish'])]);
  }, [onChange, type]);
  const {
    push
  } = useToast();
  ...
  const handleQueryChange = useObservableCallback(inputValue$ => {
    return inputValue$.pipe(filter(isNonNullable), distinctUntilChanged(), switchMap(searchString => concat(of({
      isLoading: true
  ...
  const isEditing = hasFocusAtRef; // --- click outside handling
  ...
  return /*#__PURE__*/React.createElement(RowWrapper, {
    ...
    align: "center"
  }, !isEditing && isSortable && !readOnly && /*#__PURE__*/React.createElement(Card, {
    className: "dragHandle",
    tone: "inherit",
    marginRight: 1
  }, dragHandle), isEditing ? /*#__PURE__*/React.createElement(Box, {
    flex: 1,
    padding: 1,
  ...
  }, /*#__PURE__*/React.createElement(ReferenceAutocomplete, _extends({}, elementProps, {
    ...
    align: "center"
  }, hasRef ? /*#__PURE__*/React.createElement(StyledPreviewCard, {
    flex: 1,
    padding: 1,
    paddingRight: 3,
    radius: 2,
    ...
    muted: true
  }, "Empty reference"))), /*#__PURE__*/React.createElement(Inline, {
    ...
    validation: validation
  })), !(value !== null && value !== void 0 && value._key) && /*#__PURE__*/React.createElement(Box, {
    marginLeft: 1
    ...
    mode: "outline",
    tone: "caution"
  }, "Missing key")))))), !isEditing && /*#__PURE__*/React.createElement(Box, {
    marginLeft: 1
    ...
    })), !readOnly && hasRef && /*#__PURE__*/React.createElement(MenuDivider, null), hasRef && /*#__PURE__*/React.createElement(MenuItem, {
      as: OpenLink,
      "data-as": "a",
    ...
    muted: true,
    size: 1
  }, /*#__PURE__*/React.createElement("strong", null, (_loadableReferenceInf7 = loadableReferenceInfo.result) === null || _loadableReferenceInf7 === void 0 ? void 0 : (_loadableReferenceInf8 = _loadableReferenceInf7.preview.published) === null || _loadableReferenceInf8 === void 0 ? void 0 : _loadableReferenceInf8.title), " is published and this reference should now be", ' ', type.weak ? /*#__PURE__*/React.createElement(React.Fragment, null, "finalized") : /*#__PURE__*/React.createElement(React.Fragment, null, "converted to a strong reference"), "."), /*#__PURE__*/React.createElement(Button, {
