...
import { Box, Button, Card, Flex, Inline, Menu, MenuButton, MenuDivider, MenuItem, Stack, Text, useToast } from '@sanity/ui';
...
export function ReferenceInput(props) {
  ...
  const forwardedRef = elementProps.ref; // useDidUpdate({hasFocusAt: hasFocusAtRef, ref: value?._ref}, (prev, current) => {
  ...
  return /*#__PURE__*/React.createElement(Stack, {
    ...
    align: "center",
    padding: 1
  }, /*#__PURE__*/React.createElement(StyledPreviewCard, _extends({}, elementProps, {
