...
it('renders the boolean input field', async () => {
  const {
    ...
    render: inputProps => /*#__PURE__*/React.createElement(BooleanInput, inputProps)
  });
...
describe('readOnly property', () => {
  it('makes field read-only', async () => {
    const {
      ...
      render: inputProps => /*#__PURE__*/React.createElement(BooleanInput, _extends({}, inputProps, {
        readOnly: true
      }))
    });
    ...
    userEvent.click(input); // expect(input).toHaveFocus()
