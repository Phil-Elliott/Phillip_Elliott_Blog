...
describe('fieldset with default options', () => {
  it('renders fields in a <fieldset element and includes a <legend', async () => {
    ...
    const {
      ...
      render: inputProps => {
        return /*#__PURE__*/React.createElement(ObjectInput, _extends({}, inputProps, {
          renderField: fieldProps => /*#__PURE__*/React.createElement(FieldWithTestId, fieldProps)
        }));
      }
    });
  ...
  it('does not render a toggle button for the fieldset legend ', async () => {
    const {
      ...
      fieldDefinition: fieldsetsTestType,
      render: inputProps => /*#__PURE__*/React.createElement(ObjectInput, inputProps)
    });
...
describe('collapsible fieldset with default options', () => {
  ...
  it('does not emit a new focus path when being collapsed', async () => {
    ...
    const {
      ...
      fieldDefinition: fieldsetsTestType,
      render: inputProps => /*#__PURE__*/React.createElement(ObjectInput, _extends({}, inputProps, {
