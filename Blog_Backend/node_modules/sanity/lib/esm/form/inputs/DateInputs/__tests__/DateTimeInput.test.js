...
import { DateTimeInput } from '../DateTimeInput'; // NOTE: for the tests to be deterministic we need this to ensure tests are run in a predefined timezone
...
test('does not emit onChange after invalid value has been typed', async () => {
  const {
    ...
    render: inputProps => /*#__PURE__*/React.createElement(DateTimeInput, inputProps)
  });
