...
import { defineField, defineType } from '@sanity/types'; // import {fireEvent, waitFor} from '@testing-library/react'

import React from 'react'; // import {EMPTY, of} from 'rxjs'

import { renderImageInput } from '../../../../../../test/form'; // import {UploadOptions} from '../../../../studio/uploads/types'
// import {ImageUrlBuilder} from '../../types'

import { ImageInput // ImageInputProps
} from '../ImageInput';
const defs = {
  mainImage: defineType({
    ...
    fields: [defineField({
      ...
      hidden: context => {
        ...
        return !((_context$parent = context.parent) !== null && _context$parent !== void 0 && _context$parent.caption);
      }
    }, {
      name: 'foo',
      type: 'string',
...
describe('ImageInput with empty state', () => {
  it.skip('renders an empty input as default', async () => {
    const {
      ...
      render: inputProps => /*#__PURE__*/React.createElement(ImageInput, inputProps)
