...
export default function Story() {
  return /*#__PURE__*/React.createElement(StudioProvider, {
    ...
    width: 1
  }, /*#__PURE__*/React.createElement(TestForm, null)))));
}

function TestForm() {
  const schema = useSchema(); // const readOnly = useBoolean('Read only', false)
  ...
  const renderField = useCallback(() => /*#__PURE__*/React.createElement(React.Fragment, null, "TODO"), []);
  const renderInput = useCallback(() => /*#__PURE__*/React.createElement(React.Fragment, null, "TODO"), []);
  const renderItem = useCallback(() => /*#__PURE__*/React.createElement(React.Fragment, null, "TODO"), []);
  const renderPreview = useCallback(() => /*#__PURE__*/React.createElement(React.Fragment, null, "TODO"), []);
  ...
  if (!type) {
    return /*#__PURE__*/React.createElement(React.Fragment, null, "Type not found");
  }
