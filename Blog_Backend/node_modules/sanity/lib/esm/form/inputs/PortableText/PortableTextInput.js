...
export function PortableTextInput(props) {
  ...
  const portableTextMemberItemsRef = useRef([]); // Memoized patch stream
    ...
    for (const member of members) {
      if (member.kind === 'item') {
        ...
        if (_isBlockType(member.item.schemaType)) {
          ...
          const markDefArrayMember = member.item.members.filter(_isArrayOfObjectsFieldMember).find(f => f.name === 'markDefs');
  ...
  const setFocusPathDebounced = useMemo(() => _debounce(sel => {
  ...
  const respondToInvalidContent = useMemo(() => {
    if (invalidValue && invalidValue.resolution) {
      return /*#__PURE__*/React.createElement(Box, {
        marginBottom: 2
      }, /*#__PURE__*/React.createElement(RespondToInvalidContent, {
  ...
  return /*#__PURE__*/React.createElement(Box, {
    ref: innerElementRef
  }, !readOnly && /*#__PURE__*/React.createElement(VisibleOnFocusButton, {
    onClick: handleFocusSkipperClick
  }, /*#__PURE__*/React.createElement(Text, null, "Go to content")), !ignoreValidationError && respondToInvalidContent, (!invalidValue || ignoreValidationError) && /*#__PURE__*/React.createElement(PortableTextMarkersProvider, {
    markers: markers
  }, /*#__PURE__*/React.createElement(PortableTextMemberItemsProvider, {
    memberItems: portableTextMemberItems
  }, /*#__PURE__*/React.createElement(PortableTextEditor, {
    ref: editorRef,
    ...
    type: type,
    value: value
  }, /*#__PURE__*/React.createElement(Compositor, _extends({}, props, {
    focused: focused,
    focusPath: focusPath,
    hasFocus: hasFocus,
    hotkeys: hotkeys,
