...
export class ListItemBuilder {
  ...
  serialize() {
    ...
    let listChild = child instanceof ComponentBuilder || child instanceof DocumentListBuilder || child instanceof DocumentBuilder || child instanceof ListBuilder ? child.serialize(serializeOptions) : child; // In the case of a function, create a bound version that will pass the correct serialize
