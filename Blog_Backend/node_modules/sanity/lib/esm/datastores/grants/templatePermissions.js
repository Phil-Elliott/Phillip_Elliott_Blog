 ...
 */
export function getTemplatePermissions(_ref) {
  let {
    grantsStore,
    templateItems,
    templates,
  ...
  if (!(templateItems !== null && templateItems !== void 0 && templateItems.length)) return of([]);
  ...
  }).map(promise => from(promise).pipe(switchMap(_ref2 => {
    let {
      item,
      resolvedInitialValue,
      template
...
export function useTemplatePermissions(_ref4) {
  let {
    templateItems,
    ...rest
  } = _ref4;
