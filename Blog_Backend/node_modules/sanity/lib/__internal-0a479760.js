...
const buildCommand = {
  ...
  action: async (args, context, overrides) => {
    const mod = await import('./_buildAction-599531df.js');
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./_deployAction-3f20e9fc.js');
...
const undeployCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./_undeployAction-9a7f3f22.js');
    return mod.default(args, context);
  },
  helpText: helpText$j
};
...
const followProgress = (jobId, client, output) => {
  ...
  progress(listenUrl).subscribe({
    ...
    error: err => {
      spinner.fail("There was an error copying the dataset: ".concat(err.message));
    },
    complete: () => {
...
const startCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./_startAction-5dc668df.js');
    return mod.default(args, context);
  },
  helpText: helpText$9
};
...
const execCommand = {
  ...
  helpText: helpText$8,
  action: async (args, context) => {
    const mod = await import('./_execScript-379376e1.js');
    return mod.default(args, context);
  }
};
const corsGroup = {
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./_listApisAction-177d0879.js');
    return mod.default(args, context);
  },
  helpText: helpText$4
};
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./_deployApiAction-bfcff35b.js');
    return mod.default(args, context);
  },
  helpText: helpText$3
};
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await import('./_deleteApiAction-c1ef8192.js');
    return mod.default(args, context);
  },
  helpText: helpText$2
};
