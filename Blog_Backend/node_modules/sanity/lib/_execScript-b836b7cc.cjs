...
const execScript = async function execScript2(args, context) {
  ...
  const esbuildPath = path__default["default"].resolve(__dirname, "./esbuild.js");
  const browserEnvPath = path__default["default"].resolve(__dirname, "./registerBrowserEnv.js");
  const configClientPath = path__default["default"].resolve(__dirname, "./configClient.js");
...
//# sourceMappingURL=_execScript-b836b7cc.cjs.map
