...
const buildCommand = {
  ...
  action: async (args, context, overrides) => {
    const mod = await Promise.resolve().then(function () {
      return require('./_buildAction-28d652dc.cjs');
    });
...
const deployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./_deployAction-4222cd8d.cjs');
    });
...
const undeployCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./_undeployAction-3ad24970.cjs');
    });
    return mod.default(args, context);
  },
  helpText: helpText$j
...
const startCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./_startAction-0dee1ae9.cjs');
    });
    return mod.default(args, context);
  },
  helpText: helpText$9
...
const execCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./_execScript-b836b7cc.cjs');
    });
    return mod.default(args, context);
  }
};
...
const listGraphQLAPIsCommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./_listApisAction-8a30b7c4.cjs');
    });
    return mod.default(args, context);
  },
  helpText: helpText$4
...
const deployGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./_deployApiAction-c1bb6197.cjs');
    });
    return mod.default(args, context);
  },
  helpText: helpText$3
...
const deleteGraphQLAPICommand = {
  ...
  action: async (args, context) => {
    const mod = await Promise.resolve().then(function () {
      return require('./_deleteApiAction-dc189e13.cjs');
    });
    return mod.default(args, context);
  },
  helpText: helpText$2
...
exports.debug = debug;
//# sourceMappingURL=__internal-e18d47d0.cjs.map
