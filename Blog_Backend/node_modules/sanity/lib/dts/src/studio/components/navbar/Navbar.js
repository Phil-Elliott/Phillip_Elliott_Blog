...
export function Navbar(props) {
    ...
    const brandingComponent = useMemo(() => (React.createElement(Button, { "aria-label": title, as: "a", href: rootHref, mode: "bleed", onClick: handleRootClick, padding: 3 }, rootLinkContent)), [handleRootClick, rootHref, rootLinkContent, title]);
