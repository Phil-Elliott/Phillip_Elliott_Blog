...
const FormInputInner = memo(function FormInputInner(props) {
    ...
    if (isArrayInputProps(props)) {
        ...
        return (React.createElement(ArrayOfObjectsItem, { member: itemMember, renderInput: renderInput, renderField: renderField, renderItem: pass, renderPreview: destinationRenderPreview }));
    }
