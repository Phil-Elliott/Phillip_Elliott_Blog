...
export function TextBlock(props) {
    ...
    return (React.createElement(Box, { "data-testid": "text-block", ...outerPaddingProps },
        React.createElement(TextBlockFlexWrapper, { "data-testid": "text-block__wrapper" },
            React.createElement(Flex, { flex: 1, ...innerPaddingProps, ref: memberItem?.elementRef },
                ...
                React.createElement(BlockExtrasContainer, { contentEditable: false },
                    React.createElement(BlockActionsOuter, { marginRight: 1 },
                        React.createElement(BlockActionsInner, null, renderBlockActions && focused && !readOnly && (React.createElement(BlockActions, { onChange: onChange, block: block, renderBlockActions: renderBlockActions })))),
