...
export function DateInput(props) {
    ...
    return (React.createElement(CommonDateTimeInput, { ...elementProps, deserialize: deserialize, formatInputValue: formatInputValue, onChange: handleChange, parseInputValue: parseInputValue, placeholder: schemaType.placeholder, readOnly: readOnly, selectTime: false, serialize: serialize, value: value }));
}
