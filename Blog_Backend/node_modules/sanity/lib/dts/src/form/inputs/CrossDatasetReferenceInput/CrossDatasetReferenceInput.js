...
export function CrossDatasetReferenceInput(props) {
    const { changed, focused, focusPath, getReferenceInfo, onChange, onFocusPath, onSearch, path, readOnly, schemaType, validation, value, elementProps, } = props;
    ...
    return (React.createElement(Stack, { space: 1, marginY: isEditing ? 2 : 0 }, isEditing ? (React.createElement(Stack, { space: 2, ref: clickOutsideBoundaryRef },
        React.createElement(ChangeIndicator, { path: path, isChanged: changed, hasFocus: !!focused },
            React.createElement("div", { ref: autocompletePopoverReferenceElementRef },
                React.createElement(ReferenceAutocomplete, { ...elementProps, "data-testid": "autocomplete", loading: searchState.isLoading, referenceElement: autocompletePopoverReferenceElementRef.current, portalRef: autocompletePortalRef, id: inputId || '', options: searchState.hits.map((hit) => ({
                        value: hit.id,
                        hit: hit,
                    })), onFocus: handleAutocompleteFocus, radius: 1, placeholder: "Type to search", onKeyDown: handleAutocompleteKeyDown, readOnly: readOnly, disabled: loadableReferenceInfo.isLoading, onQueryChange: handleQueryChange, searchString: searchState.searchString, onChange: handleChange, filterOption: NO_FILTER, renderOption: renderOption, openButton: { onClick: handleAutocompleteOpenButtonClick } }))))) : (React.createElement(ChangeIndicator, { path: path, isChanged: changed, hasFocus: !!focused },
        React.createElement(Card, { padding: 0, border: true, radius: 1, tone: readOnly
            ...
            React.createElement(Flex, { align: "center", padding: 1 },
                studioUrl ? (React.createElement(PreviewCard, { forwardedAs: "a", target: "_blank", rel: "noopener noreferrer", href: studioUrl, "data-as": "a", flex: 1, padding: 1, paddingRight: 3, radius: 2, tone: "inherit", __unstable_focusRing: true, tabIndex: 0, onFocus: handleFocus, ref: elementProps.ref },
                    React.createElement(PreviewReferenceValue, { value: value, referenceInfo: loadableReferenceInfo, showStudioUrlIcon: true, hasStudioUrl: !!studioUrl, type: schemaType }))) : (React.createElement(PreviewCard, { flex: 1, padding: 1, paddingRight: 3, radius: 2, tone: "inherit", __unstable_focusRing: true, tabIndex: 0, onFocus: handleFocus, ref: elementProps.ref },
