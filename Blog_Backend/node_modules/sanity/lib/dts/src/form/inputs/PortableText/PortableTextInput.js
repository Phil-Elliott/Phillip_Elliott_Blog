...
export function PortableTextInput(props) {
    const { focused, focusPath, hotkeys, markers = EMPTY_ARRAY, members, onChange, onCopy, onFocusPath, onInsert, onPaste, path, readOnly: readOnlyFromProps, renderBlockActions, renderCustomMarkers, schemaType: type, value, elementProps, } = props;
