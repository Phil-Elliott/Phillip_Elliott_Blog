    ...
    return (React.createElement(Stack, { space: 3 },
        React.createElement(Flex, null,
            React.createElement(Box, { flex: 1 },
                React.createElement(TextInput, { customValidity: errors.length > 0 ? errors[0].message : '', disabled: isUpdating, onChange: handleChange, value: value?.current || '', readOnly: readOnly, ...elementProps }),
            ...
            sourceField && (React.createElement(Box, { marginLeft: 1 },
                React.createElement(Button, { mode: "ghost", type: "button", disabled: readOnly || isUpdating, onClick: handleGenerateSlug, text: generateState?.status === 'pending' ? 'Generating…' : 'Generate' }))))));
}
