        ...
        React.createElement(ThemeProvider, { scheme: "light", theme: studioTheme },
            React.createElement(ToastProvider, null,
                React.createElement(LayerProvider, null,
                    React.createElement(ReferenceInput, { elementProps: { onFocus, onChange, ref: { current: null } }, onChange: onChange, validation: [], level: 0, liveEdit: false, focusPath: [], presence: [], onSearch: EMPTY_SEARCH, createOptions: [], editReferenceLinkComponent: StubComponent, onEditReference: noop, ...props }))))));
}
