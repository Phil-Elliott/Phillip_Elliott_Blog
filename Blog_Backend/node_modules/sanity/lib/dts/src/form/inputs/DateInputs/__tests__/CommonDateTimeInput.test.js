...
async function renderInput() {
    ...
    const ret = await renderStringInput({
        ...
        render: (props) => {
            ...
            return (React.createElement(CommonDateTimeInput, { deserialize: deserialize, id: id, formatInputValue: formatInputValue, onChange: onChange, parseInputValue: parseInputValue, readOnly: readOnly, serialize: serialize, value: value }));
        },
    });
    return { ...ret, onChange };
}
...
//# sourceMappingURL=CommonDateTimeInput.test.js.map