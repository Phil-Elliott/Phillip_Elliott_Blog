...
export class OptionsArrayInput extends React.PureComponent {
    ...
    render() {
        ...
        return (React.createElement(List, { isGrid: isGrid, tabIndex: 0, ...elementProps }, options.map((option, index) => {
            ...
            return (React.createElement(Item, { index: index, isGrid: isGrid, key: index },
                React.createElement(Flex, { align: "center", as: "label", muted: disabled },
                    React.createElement(WrappedCheckbox, { disabled: disabled, checked: checked, onChange: (e) => this.handleChange(e.currentTarget.checked, option), onFocus: () => this.handleFocus(index), readOnly: readOnly }),
                    optionType &&
                    ...
                    !optionType && (React.createElement(ItemWithMissingType, { value: option, onFocus: () => this.handleFocus(index) })))));
        })));
    }
}
