...
import { Box, Button, Container, Flex, Popover, PortalProvider, Text, useBoundaryElement, useClickOutside, useGlobalKeyDown, usePortal, } from '@sanity/ui';
...
export function PopoverEditDialog(props) {
    ...
    return (React.createElement(RootPopover, { constrainSize: true, content: React.createElement(Content, { ...props, rootElement: rootElement, width: width }), fallbackPlacements: POPOVER_FALLBACK_PLACEMENTS, placement: "bottom", open: true, portal: "default", ref: setRootElement, referenceElement: virtualElement || debugElement }));
}
function Content(props) {
    ...
    return (React.createElement(ContentContainer, { width: width },
