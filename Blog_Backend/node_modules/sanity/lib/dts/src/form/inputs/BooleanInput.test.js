...
it('renders the boolean input field', async () => {
    const { result } = await renderBooleanInput({
        ...
        render: (inputProps) => React.createElement(BooleanInput, { ...inputProps }),
    });
...
describe('readOnly property', () => {
    it('makes field read-only', async () => {
        const { onChange, result } = await renderBooleanInput({
            ...
            render: (inputProps) => React.createElement(BooleanInput, { ...inputProps, readOnly: true }),
        });
...
//# sourceMappingURL=BooleanInput.test.js.map