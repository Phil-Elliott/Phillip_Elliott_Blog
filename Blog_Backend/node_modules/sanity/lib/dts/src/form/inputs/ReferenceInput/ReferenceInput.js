...
export function ReferenceInput(props) {
    const { createOptions, editReferenceLinkComponent: EditReferenceLink, focusPath = EMPTY_ARRAY, focused, path, getReferenceInfo, liveEdit, onChange, onEditReference, onSearch, selectedState, schemaType, changed, readOnly, onFocusPath, validation, value, renderPreview, elementProps, } = props;
    ...
    return (React.createElement(Stack, { space: 1 }, isEditing || isWeakRefToNonexistent ? (React.createElement(Stack, { space: 2, ref: clickOutsideBoundaryRef },
        ...
        React.createElement(ChangeIndicator, { path: REF_PATH, hasFocus: !!focused, isChanged: changed },
            React.createElement(AutocompleteContainer, { ref: autocompletePopoverReferenceElementRef },
                React.createElement(ReferenceAutocomplete, { ...elementProps, "data-testid": "autocomplete", loading: searchState.isLoading, referenceElement: autocompletePopoverReferenceElementRef.current, portalRef: autocompletePortalRef, options: searchState.hits.map((hit) => ({
                        value: hit.id,
                        hit: hit,
                    })), radius: 1, placeholder: "Type to search", onKeyDown: handleAutocompleteKeyDown, readOnly: readOnly, disabled: loadableReferenceInfo.isLoading, onQueryChange: handleQueryChange, searchString: searchState.searchString, onChange: handleChange, filterOption: NO_FILTER, renderOption: renderOption, openButton: { onClick: handleAutocompleteOpenButtonClick } }),
        ...
        React.createElement(Card, { border: true, radius: 1, tone: readOnly
            ...
            React.createElement(Flex, { align: "center", padding: 1 },
                React.createElement(StyledPreviewCard, { ...elementProps, __unstable_focusRing: true, forwardedAs: EditReferenceLink, "data-as": "a", "data-pressed": pressed ? true : undefined, "data-selected": selected ? true : undefined, documentId: value?._ref, documentType: refType?.name, flex: 1, onKeyPress: handlePreviewKeyPress, padding: 1, paddingRight: 3, pressed: pressed, radius: 2, selected: selected, tabIndex: 0, tone: selected ? 'default' : 'inherit' },
