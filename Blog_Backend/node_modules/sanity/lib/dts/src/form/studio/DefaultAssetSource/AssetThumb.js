...
const DPI = typeof window === 'undefined' || !window.devicePixelRatio
    ? 1
...
`;
export const AssetThumb = React.memo(function AssetThumb(props) {
    ...
    return (React.createElement(Root, null,
        React.createElement(Button, { tone: "primary", selected: isSelected, tabIndex: 0, "data-id": _id, mode: "ghost", onKeyPress: onKeyPress, padding: 0, style: { padding: 2 } },
            React.createElement(Container, { __unstable_checkered: true },
                React.createElement(Image, { alt: originalFilename, src: imageUrl, onClick: onClick, "data-id": _id }),
                isDeleting && React.createElement(FullscreenSpinner, null))),
        React.createElement(MenuContainer, null,
            React.createElement(AssetMenu, { isSelected: isSelected, onAction: handleMenuAction })),
        (showUsageDialog || showDeleteDialog) && (React.createElement(AssetUsageDialog, { asset: asset, mode: showDeleteDialog ? 'confirmDelete' : 'listUsage', onClose: handleDialogClose, onDelete: handleDeleteAsset, isDeleting: isDeleting }))));
});
//# sourceMappingURL=AssetThumb.js.map