...
export function StudioFormBuilder(props) {
    const { __internal_patchChannel: patchChannel, autoFocus, changesOpen, collapsedFieldSets, collapsedPaths, focusPath, focused, groups, id, members, onChange, onPathBlur, onPathFocus, onPathOpen, onFieldGroupSelect, onSetFieldSetCollapsed, onSetPathCollapsed, presence, readOnly, schemaType, validation, value, } = props;
    return (React.createElement(StudioFormBuilderProvider, { __internal_patchChannel: patchChannel, autoFocus: autoFocus, changesOpen: changesOpen, collapsedFieldSets: collapsedFieldSets, collapsedPaths: collapsedPaths, focusPath: focusPath, focused: focused, groups: groups, id: id, members: members, onChange: onChange, onPathBlur: onPathBlur, onPathFocus: onPathFocus, onPathOpen: onPathOpen, onFieldGroupSelect: onFieldGroupSelect, onSetPathCollapsed: onSetPathCollapsed, onSetFieldSetCollapsed: onSetFieldSetCollapsed, presence: presence, validation: validation, readOnly: readOnly, schemaType: schemaType, value: value },
        React.createElement(RootInput, null)));
}
function RootInput() {
    const { focusPath, focused, groups, id, members, readOnly, renderField, renderInput, renderItem, renderPreview, schemaType, value, } = useFormBuilder();
    const { onChange, onFieldGroupSelect, onPathBlur, onPathFocus, onPathOpen, onSetFieldSetCollapsed, onSetPathCollapsed, } = useFormCallbacks();
    ...
    return React.createElement(React.Fragment, null, renderInput(rootInputProps));
}
//# sourceMappingURL=StudioFormBuilder.js.map