...
export function StudioReferenceInput(props) {
    ...
    return (React.createElement(ReferenceInput, { ...props, onSearch: handleSearch, liveEdit: isDocumentLiveEdit, getReferenceInfo: getReferenceInfo, selectedState: selectedState, editReferenceLinkComponent: EditReferenceLink, createOptions: createOptions, onEditReference: handleEditReference }));
}
//# sourceMappingURL=StudioReferenceInput.js.map