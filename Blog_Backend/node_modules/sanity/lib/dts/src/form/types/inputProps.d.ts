import { ArraySchemaType, BooleanSchemaType, NumberSchemaType, ObjectSchemaType, Path, SchemaType, StringSchemaType } from '@sanity/types';
import * as React from 'react';
import { FocusEventHandler, FormEventHandler } from 'react';
import { FormPatch, PatchEvent } from '../patch';
import { ArrayOfObjectsFormNode, ArrayOfPrimitivesFormNode, BooleanFormNode, NumberFormNode, ObjectFormNode, StringFormNode } from '../store/types/nodes';
import { RenderArrayOfObjectsItemCallback, RenderArrayOfPrimitivesItemCallback, RenderFieldCallback, RenderInputCallback, RenderPreviewCallback } from './renderCallback';
...
}, S extends ObjectSchemaType = ObjectSchemaType> extends ObjectFormNode<T, S> {
...
export interface ArrayOfObjectsInputProps<T extends {
    _key: string;
} = {
    _key: string;
}, S extends ArraySchemaType = ArraySchemaType> extends ArrayOfObjectsFormNode<T[], S> {
    onChange: (patch: FormPatch | FormPatch[] | PatchEvent) => void;
...
export declare type ArrayOfPrimitivesElementType<T extends any[]> = T extends (infer K)[] ? K : unknown;
export interface ArrayOfPrimitivesInputProps<T extends (string | boolean | number)[] = (string | boolean | number)[], S extends ArraySchemaType = ArraySchemaType> extends ArrayOfPrimitivesFormNode<T, S> {
...
export interface StringInputProps<S extends StringSchemaType = StringSchemaType> extends StringFormNode<S> {
    onChange: (patch: FormPatch | FormPatch[] | PatchEvent) => void;
    validationError?: string;
    elementProps: PrimitiveInputElementProps;
}
export interface NumberInputProps<S extends NumberSchemaType = NumberSchemaType> extends NumberFormNode<S> {
    onChange: (patch: FormPatch | FormPatch[] | PatchEvent) => void;
    validationError?: string;
    elementProps: PrimitiveInputElementProps;
}
export interface BooleanInputProps<S extends BooleanSchemaType = BooleanSchemaType> extends BooleanFormNode<S> {
    onChange: (patch: FormPatch | FormPatch[] | PatchEvent) => void;
    /**
...
export declare type InputProps = ObjectInputProps | ArrayOfObjectsInputProps | ArrayOfPrimitivesInputProps | StringInputProps | BooleanInputProps | NumberInputProps;
