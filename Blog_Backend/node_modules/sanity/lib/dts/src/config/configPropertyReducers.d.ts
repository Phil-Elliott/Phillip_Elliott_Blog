...
import type { _DocumentLanguageFilterComponent, _DocumentLanguageFilterContext, AsyncConfigPropertyReducer, ConfigContext, ConfigPropertyReducer, DocumentActionsContext, DocumentBadgesContext, NewDocumentOptionsContext, ResolveProductionUrlContext, Tool } from './types';
...
export declare const schemaTypesReducer: ConfigPropertyReducer<Schema.TypeDefinition[], Omit<ConfigContext, 'schema' | 'currentUser' | 'client' | 'getClient'>>;
