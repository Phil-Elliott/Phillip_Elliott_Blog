...
import { InitialValueTemplateItem, Template } from '../../templates';
 ...
 */
export declare function getTemplatePermissions({ grantsStore, templateItems, templates, schema, context, }: TemplatePermissionsOptions): Observable<Array<TemplatePermissionsResult<Record<string, unknown>>>>;
/**
