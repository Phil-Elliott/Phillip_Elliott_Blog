...
function getInitialValueStream(schema, initialValueTemplates, documentPreviewStore, opts, context) {
  ...
  return value$.pipe((0, _operators.switchMap)(document => {
    ...
    const initialValueWithParams$ = (0, _rxjs.from)((0, _templates.resolveInitialValue)(schema, template, opts.templateParams, context)).pipe((0, _operators.map)(initialValue => ({
      isResolving: false,
      initialValue
