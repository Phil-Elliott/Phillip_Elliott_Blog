...
function Navbar(props) {
  ...
  const brandingComponent = (0, _react.useMemo)(() => /*#__PURE__*/_react.default.createElement(_ui.Button, {
    ...
    onClick: handleRootClick,
    padding: 3
  }, rootLinkContent), [handleRootClick, rootHref, rootLinkContent, title]); // The HTML elements that are part of the search view (i.e. the "close" button that is visible
  ...
  return /*#__PURE__*/_react.default.createElement(RootLayer, {
    ...
    marginRight: 2
  }, /*#__PURE__*/_react.default.createElement(_ConfigIssuesButton.ConfigIssuesButton, null)), shouldRender.tools && /*#__PURE__*/_react.default.createElement(_ui.Box, null, /*#__PURE__*/_react.default.createElement(_userMenu.UserMenu, null)), shouldRender.searchFullscreen && /*#__PURE__*/_react.default.createElement(_ui.Button, {
