...
function normalizeIcon(icon, title) {
  ...
  if ((0, _reactIs.isValidElementType)(icon)) return /*#__PURE__*/(0, _react.createElement)(icon);
...
function prepareConfig(config) {
  ...
  const workspaces = workspaceOptions.map(_ref => {
    ...
    const workspaceSummary = {
      ...
      icon: normalizeIcon(rootSource.icon, title, "".concat(rootSource.projectId, " ").concat(rootSource.dataset)),
...
function getBifurClient(client, auth) {
  ...
  return (0, _bifurClient.fromUrl)(url, options);
}
