...
exports._findMatchingRoutes = _findMatchingRoutes;
...
function _findMatchingRoutes(node, _state) {
  ...
  const stateKeys = (0, _util.isRecord)(state) ? Object.keys(state) : [];
  ...
  const children = (0, _arrayify.arrayify)((typeof node.children === 'function' ? node.children((0, _util.isRecord)(state) ? state : {}) : node.children) || []);
