...
var _parseRoute2 = require("./_parseRoute");

var _resolveStateFromPath2 = require("./_resolveStateFromPath");

var _resolvePathFromState2 = require("./_resolvePathFromState");
...
function createNode(options) {
  ...
  const parsedRoute = (0, _parseRoute2._parseRoute)(path);
  return {
    _isRoute: true,
    ...
    encode(state) {
      return (0, _resolvePathFromState2._resolvePathFromState)(this, state);
    },

    decode(_path) {
      return (0, _resolveStateFromPath2._resolveStateFromPath)(this, _path);
    },
