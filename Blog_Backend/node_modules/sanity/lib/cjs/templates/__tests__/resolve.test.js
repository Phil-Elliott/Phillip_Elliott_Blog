...
describe('resolveInitialValue', () => {
  test('serializes builders', () => {
    expect((0, _.resolveInitialValue)(_schema.schema, example, {}, mockConfigContext)).resolves.toMatchObject({
      title: 'here'
    });
  });
  ...
  test('throws on missing template `value` prop', () => {
    expect((0, _.resolveInitialValue)(_schema.schema, (0, _omit2.default)(example, ['value']), {}, mockConfigContext)).rejects.toMatchObject({
      message: 'Template "author" has invalid "value" property'
    });
  });
  test('throws on non-function/non-object template `value` prop', () => {
    expect((0, _.resolveInitialValue)(_schema.schema, { ...example,
      value: []
  ...
  test('applies missing `_key` to array object children', async () => {
    const result = await (0, _.resolveInitialValue)(_schema.schema, { ...example,
      value: {
        categories: [{
          _ref: 'php'
        }, {
