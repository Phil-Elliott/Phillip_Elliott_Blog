...
exports.DEFAULT_MAX_RECURSION_DEPTH = void 0;
...
async function resolveInitialValue(schema, template) {
  ...
  const newValue = (0, _deepAssign.default)((await resolveInitialValueForType(schemaType, params, DEFAULT_MAX_RECURSION_DEPTH, context)) || {}, resolvedValue); // revalidate and return new initial values
