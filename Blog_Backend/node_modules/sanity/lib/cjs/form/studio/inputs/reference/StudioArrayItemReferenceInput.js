...
exports.StudioArrayItemReferenceInput = StudioArrayItemReferenceInput;
...
function StudioArrayItemReferenceInput(props) {
  ...
  const isDocumentLiveEdit = (0, _react.useMemo)(() => {
    var _schema$get;

    return (_schema$get = schema.get(documentTypeName)) === null || _schema$get === void 0 ? void 0 : _schema$get.liveEdit;
  ...
  const createOptions = (0, _react.useMemo)(() => {
    ...
    ).filter(i => schemaType.to.some(refType => {
      var _i$template;

      return refType.name === ((_i$template = i.template) === null || _i$template === void 0 ? void 0 : _i$template.schemaType);
    })).map(item => {
      var _item$template;
