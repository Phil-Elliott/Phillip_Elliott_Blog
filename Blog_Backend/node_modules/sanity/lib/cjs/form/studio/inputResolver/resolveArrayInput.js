...
function resolveArrayInput(type) {
  ...
  if (hasOptionsList(type)) {
    return _OptionsArrayInput.OptionsArrayInput;
  } // Special component for array of primitive values


  if (isArrayOfPrimitives(type)) {
    return _StudioArrayInput.StudioArrayOfPrimitivesInput;
  ...
  return _StudioArrayInput.StudioArrayInput;
}