...
var _prettyBytes = require("./prettyBytes");
...
const AssetRow = props => {
  const versionedClient = (0, _hooks.useClient)(_studioClient.DEFAULT_STUDIO_CLIENT_OPTIONS);
  ...
  const formattedTime = (0, _hooks.useTimeAgo)(_createdAt, {
    agoSuffix: true
  });
  const formattedMimeType = (0, _mimeType.formatMimeType)(mimeType);
  const formattedSize = (0, _prettyBytes.prettyBytes)(size);
