...
var _helpers = require("../../inputs/arrays/ArrayOfObjectsInput/item/helpers");
 ...
 * @alpha
 */
function ArrayOfObjectsItem(props) {
  ...
  const isEmptyValue = !member.item.value || (0, _helpers.isEmpty)(member.item.value);
  ...
  const elementProps = (0, React.useMemo)(() => ({
    onBlur: handleBlur,
    onFocus: handleFocus,
    id: member.item.id,
    ref: focusRef
