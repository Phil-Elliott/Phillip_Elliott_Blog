...
var _helpers = require("../studio/inputResolver/helpers");
...
function prepareFieldMember(props) {
  ...
  const fieldLevel = (0, _helpers.getFieldLevel)(field.type, parent.level + 1);
...
function prepareObjectInputState(props) {
  ...
  const members = normalizedSchemaMembers.flatMap((fieldSet, index) => {
    ...
    const fieldsetReadOnly = (0, _conditionalProperty.resolveConditionalProperty)(fieldSet.readOnly, {
      currentUser: props.currentUser,
      document: props.document,
      parent: props.value,
      value: (0, _pick2.default)(props.value, fieldsetFieldNames)
