...
test('does not emit onChange after invalid value has been typed', async () => {
  const {
    ...
    fieldDefinition: (0, _types.defineField)({
      type: 'date',
      name: 'test'
    }),
    render: inputProps => /*#__PURE__*/_react2.default.createElement(_DateInput.DateInput, inputProps)
  });
...
test('emits onChange on correct format if a valid value has been typed', async () => {
  ...
  _userEvent.default.type(input, '2021-03-28');
