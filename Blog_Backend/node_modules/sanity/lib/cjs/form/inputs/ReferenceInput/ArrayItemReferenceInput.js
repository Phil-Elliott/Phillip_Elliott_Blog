...
function ArrayItemReferenceInput(props) {
  ...
  const forwardedRef = (0, _ui.useForwardedRef)(elementProps.ref);
  const [searchState, setSearchState] = (0, _react.useState)(INITIAL_SEARCH_STATE);

  const handleCreateNew = option => {
    const id = (0, _uuid.uuid)();
    const patches = [(0, _patch.setIfMissing)({}), (0, _patch.set)(type.name, ['_type']), (0, _patch.set)(id, ['_ref']), (0, _patch.set)(true, ['_weak']), (0, _patch.set)({
      type: option.type,
      weak: type.weak,
  ...
  const handleInsert = (0, _react.useCallback)(pos => {
    if (value !== null && value !== void 0 && value._key) {// todo
      // onInsert?.({
  ...
  const handleChange = (0, _react.useCallback)(id => {
    ...
    const patches = [(0, _patch.setIfMissing)({}), (0, _patch.set)(type.name, ['_type']), (0, _patch.set)((0, _util.getPublishedId)(id), ['_ref']), // if there's no published version of this document, set the reference to weak
    hit.published && !type.weak ? (0, _patch.unset)(['_weak']) : (0, _patch.set)(true, ['_weak']), hit.published ? (0, _patch.unset)(['_strengthenOnPublish']) : (0, _patch.set)({
  ...
  const handleCancelEdit = (0, _react.useCallback)(() => {
  ...
  const getReferenceInfoMemo = (0, _react.useCallback)(id => getReferenceInfo(id, type), [getReferenceInfo, type]);
  ...
  const handleFixStrengthMismatch = (0, _react.useCallback)(() => {
    onChange(type.weak === true ? (0, _patch.set)(true, ['_weak']) : (0, _patch.unset)(['_weak']));
  }, [onChange, type]);
  ...
  const handleRemoveStrengthenOnPublish = (0, _react.useCallback)(() => {
    onChange([type.weak === true ? (0, _patch.set)(true, ['_weak']) : (0, _patch.unset)(['_weak']), (0, _patch.unset)(['_strengthenOnPublish'])]);
  }, [onChange, type]);
  const {
    push
  } = (0, _ui.useToast)();
  ...
  return /*#__PURE__*/_react.default.createElement(_RowWrapper.RowWrapper, {
  ...
  }, /*#__PURE__*/_react.default.createElement(_ReferenceAutocomplete.ReferenceAutocomplete, _extends({}, elementProps, {
    ...
    validation: validation
  })), !(value !== null && value !== void 0 && value._key) && /*#__PURE__*/_react.default.createElement(_ui.Box, {
    marginLeft: 1
