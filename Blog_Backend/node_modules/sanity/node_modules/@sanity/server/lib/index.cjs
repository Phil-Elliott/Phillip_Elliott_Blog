...
function getAliases(opts) {
  ...
  const aliasesPath = path__default["default"].join(monorepo.path, "dev", "aliases");
...
const debug = debugIt__default["default"]("sanity:server");
...
function getEntryModule(options) {
  return entryModule.replace(/%STUDIO_CONFIG_LOCATION%/, JSON.stringify(options.relativeConfigLocation));
}
