...
export default function validateDocument(getClient: (options: {
    apiVersion: string;
}) => SanityClient, doc: SanityDocument, schema: Schema, context?: Pick<ValidationContext, 'getDocumentExists'>): Promise<ValidationMarker[]>;
/**
