...
export declare type PatchTypes = DiffMatchPatch | IncPatch | InsertPatch | SetIfMissingPatch | SetPatch | UnsetPatch;
export declare type SingleDocumentPatch = PatchOperations & {
    id: string;
};
