...
export declare type SymbolClass = 'boolean' | 'operator' | 'comparator' | 'keyword' | 'paren';
...
export declare type Token = QuotedToken | IdentifierToken | NumberToken | SymbolToken;
export declare type Expr = UnionExpr | PathExpr | ConstraintExpr | RecursiveExpr | IndexExpr | AttributeExpr | AliasExpr | RangeExpr | StringExpr | BooleanExpr | NumberExpr;
