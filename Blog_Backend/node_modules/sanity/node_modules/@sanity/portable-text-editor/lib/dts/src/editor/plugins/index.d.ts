...
export declare const withPlugins: <T extends import("slate").BaseEditor & import("@sanity/slate-react").ReactEditor & PortableTextSlateEditor>(editor: T, options: createEditorOptions) => PortableTextSlateEditor;
