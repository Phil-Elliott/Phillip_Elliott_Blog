...
describe('common type test', () => {
    it('should capture literal string type', () => {
        ...
        let type = stringDef.type;
        let name = stringDef.name;
        ...
        const arrayOfType = stringArrayOf.type;
        const arrayOfName = stringArrayOf.name;
    });
    ...
    it('should allow ReactElement for description', () => {
        ...
        defineType({
            type: 'text',
            name: 'text',
            description: React.createElement("strong", null, "Some like it bold"),
        });
        defineType({
            type: 'text',
            name: 'text',
            //@ts-expect-error ReactElement but not ReactNode
            description: () => React.createElement("strong", null, "Render function not supported "),
        });
    });
});
