...
describe('string types', () => {
    describe('defineType', () => {
        it('should define string schema', () => {
            ...
            const assignableToString = stringDef;
            // @ts-expect-error string is not assignable to boolean
            const notAssignableToBoolean = stringDef;
        });
    ...
    describe('defineField', () => {
        it('should define string field', () => {
            ...
            const assignableToString = stringField;
            const nameIsNarrowed = stringField.name;
            const assignableToFieldDef = defineField({
                type: 'string',
                name: 'nestedField',
                options: {
                    layout: 'dropdown',
