...
describe('document types', () => {
    describe('defineType', () => {
        it('should define document schema', () => {
            ...
            const assignableToDocument = documentDef;
            // @ts-expect-error document is not assignable to string
            const notAssignableToString = documentDef;
        });
        ...
        it('should define document fields safely (with some compromises without defineField)', () => {
            ...
            const documentDef = defineType({
                ...
                fields: [
                    ...
                    },
                    {
                        ...
                        validation: (Rule) => Rule.custom((value) => value?.something === 'false' ? true : 'Error'),
                    },
                    {
                        type: 'array',
                        name: 'arrayField',
            ...
            let assignableToDocument = documentDef;
