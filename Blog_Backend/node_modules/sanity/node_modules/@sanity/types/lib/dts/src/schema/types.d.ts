...
export declare namespace Schema {
     ...
     * itself.
     */
    export type TypeDefinition<TType extends Type = Type> = IntrinsicTypeDefinition[Type] | TypeAliasDefinition<string, TType>;
    /**
     ...
     */
    export type TypeAliasDefinition<TType extends string, TAlias extends Type | undefined> = BaseDefinitionOptions & {
        type: TType;
    ...
    export type InlineFieldDefinition = {
        [K in keyof IntrinsicTypeDefinition]: Omit<IntrinsicTypeDefinition[K], 'initialValue' | 'validation'> & {
            validation?: SchemaValidationValue;
            initialValue?: InitialValueProperty<any, any>;
        };
    };
     ...
     *
     */
    export type FieldDefinition<TType extends Type = Type, TAlias extends Type | undefined = undefined> = (InlineFieldDefinition[TType] | TypeAliasDefinition<string, TAlias>) & FieldBase;
    ...
    type IntrinsicArrayOfDefinition = {
        [K in keyof IntrinsicTypeDefinition]: Omit<ArrayOfEntry<IntrinsicTypeDefinition[K]>, 'validation' | 'initialValue'> & {
            validation?: SchemaValidationValue;
            initialValue?: InitialValueProperty<any, any>;
        };
    };
    export type ArrayOfType<TType extends Type = Type, TAlias extends Type | undefined = undefined> = IntrinsicArrayOfDefinition[TType] | ArrayOfEntry<TypeAliasDefinition<string, TAlias>>;
