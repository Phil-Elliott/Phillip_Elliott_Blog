...
import type { DefineArrayMemberBase, DefineOptions, DefineSchemaBase, MaybeAllowUnknownProps, NarrowPreview, StrictDefinition, WidenInitialValue, WidenValidation } from './defineTypes';
/**
 ...
 * @see typed
 */
export declare function defineType<TType extends string | Schema.Type, // Schema.Type here improves autocompletion in _some_ IDEs (not VS Code atm)
TName extends string, TSelect extends Record<string, string> | undefined, TPrepareValue extends Record<keyof TSelect, any> | undefined, TAlias extends Schema.Type | undefined, TStrict extends StrictDefinition>(schemaDefinition: {
    type: TType;
    name: TName;
} & DefineSchemaBase<TType, TAlias> & NarrowPreview<TType, TAlias, TSelect, TPrepareValue> & MaybeAllowUnknownProps<TStrict>, defineOptions?: DefineOptions<TStrict, TAlias>): typeof schemaDefinition;
/**
 ...
 * @see typed
 */
export declare function defineField<TType extends string | Schema.Type, // Schema.Type here improves autocompletion in _some_ IDEs (not VS Code atm)
TName extends string, TSelect extends Record<string, string> | undefined, TPrepareValue extends Record<keyof TSelect, any> | undefined, TAlias extends Schema.Type | undefined, TStrict extends StrictDefinition>(schemaField: {
    type: TType;
    name: TName;
} & DefineSchemaBase<TType, TAlias> & NarrowPreview<TType, TAlias, TSelect, TPrepareValue> & MaybeAllowUnknownProps<TStrict> & Schema.FieldBase, defineOptions?: DefineOptions<TStrict, TAlias>): typeof schemaField & WidenValidation & WidenInitialValue;
/**
 ...
 * @see typed
 */
export declare function defineArrayMember<TType extends string | Schema.Type, // Schema.Type here improves autocompletion in _some_ IDEs (not VS Code atm)
TName extends string, TSelect extends Record<string, string> | undefined, TPrepareValue extends Record<keyof TSelect, any> | undefined, TAlias extends Schema.Type | undefined, TStrict extends StrictDefinition>(arrayOfSchema: {
    type: TType;
    /**
     ...
     */
    name?: TName;
} & DefineArrayMemberBase<TType, TAlias> & NarrowPreview<TType, TAlias, TSelect, TPrepareValue> & MaybeAllowUnknownProps<TStrict>, defineOptions?: DefineOptions<TStrict, TAlias>): typeof arrayOfSchema & WidenValidation & WidenInitialValue;
/**
