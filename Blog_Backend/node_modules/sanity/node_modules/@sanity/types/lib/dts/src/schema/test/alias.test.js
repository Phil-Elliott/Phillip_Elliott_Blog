...
describe('alias type test', () => {
    it('should support narrowing alias types', () => {
        ...
        const notAssignableToStringOptions = notStringDef.options;
        ...
        const assignableToStringOptions = narrowedAlias.options;
    });
    it('should support aliased array', () => {
        ...
        const assignableToArrayOptions = narrowedAlias.options;
    });
    it('should support aliased object', () => {
        ...
        const assignableToObjectOptions = narrowedAlias.options;
        defineType({
            type: 'custom-object',
            name: 'redefined-custom-object',
