...
var node$2 = require('esbuild-register/dist/node');
...
}(Subscriber_1.Subscriber); //  Since `@sanity/client` doesn't offer ESM exports (yet) const {filter} = require('rxjs/operators') will cause the the whole of rxjs to be included in the bundle.
...
var encodeQueryString$2 = function (_ref) {
  var query = _ref.query,
      ...
      options = _ref$options === void 0 ? {} : _ref$options; // We generally want tag at the start of the query string
...
async function getCliWorkerPath(workerPath) {
  ...
  const resolvedPath = path__default["default"].resolve(cliDir, "lib", workerPath);
...
function getSanityJsonConfig(cwd) {
  ...
  if (!require$$0__default$4["default"].existsSync(configPath)) {
    return null;
  }
...
function getSanityCliConfig(cwd) {
  ...
  const [js, ts] = [require$$0__default$4["default"].existsSync(jsConfigPath), require$$0__default$4["default"].existsSync(tsConfigPath)];
...
function loadJsonConfig(filePath) {
  try {
    const content = require$$0__default$4["default"].readFileSync(filePath, "utf8");
...
//# sourceMappingURL=_resolveRootDir-ab271d25.cjs.map
